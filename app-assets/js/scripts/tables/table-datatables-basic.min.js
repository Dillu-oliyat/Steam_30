$((function() {
		...
		var n = e.DataTable({
			...
			columnDefs: [{
				...
				render: function(e, t, a, s) {
					...
					return void 0 === o[l] ? e : '<span class="badge rounded-pill ' + o[l].class + '">' + o[l].title + "</span>"
				}
			}, {
				targets: -1,
				title: "Actions",
	...
	var r = 101;
	if ($(".data-submit").on("click", (function() {
